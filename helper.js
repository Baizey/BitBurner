export function getFiles() {
    return [
        ...
        'helper.js',      // General helper for other files
        'primes.js',      // simply holds function to first 100.000 primes
        'Runner.js',    // Runner class, used to start/stop/await other scripts
